...
import { Asset, AssetPosition, Track, TrackPosition } from "@/lib/types"
import { useAppDispatch } from "@/store/hook"
import { updateAsset, updateTrack } from "@/store/slices/missionSlice"
...
type Props = {
    asset: Asset,
    onCreate: (assetPosition: AssetPosition) => void
}

const NewAssetPosition = ({ asset, onCreate }: Props) => {
    ...
    const handleAddPosition = async () => {
        try {
            ...
            const oldPositions = asset.positions || []
            dispatch(updateAsset({ id: asset.id, positions: [res.data.data, ...oldPositions ] }))
        ...
        <Popover>
            <PopoverTrigger asChild>
                <Button variant="outline" className="" size='sm'>
                    <PlusIcon className="h-4 w-4" />Asset Pos.
                </Button>
            </PopoverTrigger>
                ...
                <div className="grid gap-4">
                    <div className="space-y-2">
                        ...
                        <p className="text-muted-foreground text-sm">
                            Set new position for the asset.
                        </p>
                    </div>
...
export default NewAssetPosition