export const dark_style = {
  ...
  "sources": {
    "openmaptiles": {
      "type": "vector",
      "url": "http://localhost:8080/data/map.json"
    }
  },
  ...
  "layers": [
    ...
    },
    {
      ...
      "paint": {
        ...
        "text-halo-color": "rgba(156, 33, 33, 1)"
      }
    },
    {
    ...
    },
    {
      ...
      "paint": {
        "text-color": "rgba(255, 231, 93, 1)",
        "text-halo-blur": 0,
        "text-halo-color": "rgba(0, 0, 0, 1)",
        "text-halo-width": 1,
        "text-translate": [0, 0],
        "icon-color": "rgba(197, 197, 197, 1)"
      }
    },
    {
